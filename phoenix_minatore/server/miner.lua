...
RegisterServerEvent('phoenix_minatore:pickedUpStone')
AddEventHandler('phoenix_minatore:pickedUpStone', function()
...
RegisterServerEvent('phoenix_minatore:lavaggioPietre')
AddEventHandler('phoenix_minatore:lavaggioPietre', function()
	if not playersProcessingStone[source] then
		...
		print(('phoenix_minatore: %s attempted to exploit stone processing!'):format(GetPlayerIdentifiers(source)[1]))
	end
end)
