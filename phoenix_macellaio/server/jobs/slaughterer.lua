...
RegisterServerEvent('phoenix_macellaio:pickedUpPojo')
AddEventHandler('phoenix_macellaio:pickedUpPojo', function()
...
RegisterServerEvent('phoenix_macellaio:ProcessPojo')
AddEventHandler('phoenix_macellaio:ProcessPojo', function()
	if not playersProcessingPojo[source] then
		...
		print(('phoenix_macellaio: %s attempted to exploit Pojo processing!'):format(GetPlayerIdentifiers(source)[1]))
	end
end)
